...
<View style={{
    ...
    <View style={styles.socialContainer}>
        <Image source={Facebook} style={{height: 30, width: 30, marginLeft: 'auto', marginRight: 'auto', marginTop: 'auto', marginBottom: 'auto'}}/>
            ...
            <Text style={{textAlign: 'center', marginTop: 20, marginBottom: 60}} appearance="hint">Already have an account?  <Text style={{color: 'rgba(0,152,153,255)'}} onPress={()=>props.navigation.navigate("Login")}>SignIn</Text></Text>
        </ScrollView>
    )
}
