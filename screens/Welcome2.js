       ...
       <Layout style={styles.container}>
        ...
        <View style={styles.content}>
            <View style={styles.wordContainer}>
                ...
                }}>Live talk with doctors</Text>

                <Text style={{
                    textAlign: 'center',
                    fontSize: 13,
                    marginTop: 25
                }} appearance="hint">Easily connect with doctor and start video chat for your better treatment & Prescription</Text>
                ...
                }} onPress={()=>props.navigation.navigate("Welcome3")}>Get started</Button>
                <Text style={{textAlign: 'center', marginTop: 20, marginBottom: 20}} appearance="hint" onPress={()=>props.navigation.navigate("Login")}>Skip for now</Text>
            </View>
        </View>
        </ImageBackground>
