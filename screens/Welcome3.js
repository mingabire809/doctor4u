        ...
        <View style={styles.content}>
            <View style={styles.wordContainer}>
                ...
                <Text style={{
                    ...
                    fontSize: 13,
                    marginTop: 25
                }} appearance="hint">Book an appointment with doctor. Chat with doctor via appointment letter. Get consultent</Text>
                ...
                <Button style={{
                    ...
                    marginBottom: 20
                }} onPress={()=>props.navigation.navigate("Login")}>Get started</Button>
